...
import { y as buildErrorThrower } from "./error-BgFRsb8s.mjs";
...
import { n as versionSelector } from "./versionSelector-fUtia4r1.mjs";
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = versionSelector(__internal_clerkUIVersion, "1.13.0");
